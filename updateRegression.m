...
figure()
surf(X1,X2,G(X1,X2),'EdgeColor','none','FaceAlpha',0.4,'FaceColor','green');
grid on
hold on

surf(X1,X2,kernEstimate,'FaceAlpha',0.3,'EdgeColor','none','FaceColor','blue')
...
zlabel('$\hat{g}_N$','fontsize',font_sz_labels,'interpreter','latex')
text(5,-20,0,'$\phi(t)$','fontsize',font_sz_labels,'interpreter','latex','color','black')
text(-20,25,250,'$G$','fontsize',font_sz,'interpreter','latex','color','green')
% text(-30,30,450,strcat('$\gamma = $',figstr),'fontsize',font_sz_labels,'interpreter','latex')
% text(-30,20,500,strcat('After  $',figstr, '$ seconds'),'fontsize',36,'interpreter','latex')
set(gcf,'Position',[100 100 800 600])
%
saveas(gcf,'kernelestimate','epsc')